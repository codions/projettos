      ...
      <div class="lg:flex lg:items-center lg:justify-between">
        <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center space-x-2">
                ...
                <p class="text-gray-500 text-sm">{{ trans('tickets.last-updated-by-user-at-datetime', [
        ...
        <div class="mt-5 flex lg:mt-0 lg:ml-4 space-x-2">
            <x-filament::button color="secondary" wire:click="$emit('openModal', 'modals.ticket.update-status', {{ json_encode(['ticket' => $ticket->id, 'status' => 'closed']) }})">
                {{ trans('tickets.close-ticket') }}
            </x-filament::button>

            <button wire:click="$emit('openModal', 'modals.ticket.activities', {{ json_encode(['ticket' => $ticket->id]) }})" class="filament-button filament-button-size-md inline-flex items-center justify-center py-1 gap-1 font-medium rounded-lg border transition-colors outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset dark:focus:ring-offset-0 min-h-[2.25rem] px-4 text-sm text-gray-800 bg-white border-gray-300 hover:bg-gray-50 focus:ring-primary-600 focus:text-primary-600 focus:bg-primary-50 focus:border-primary-600 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-600 dark:hover:border-gray-500 dark:text-gray-200 dark:focus:text-primary-400 dark:focus:border-primary-400 dark:focus:bg-gray-800">
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" viewBox="0 0 448 448" style="enable-background:new 0 0 512 512" xml:space="preserve" class="w-6 h-6">
                    <g>
            ...
            <x-dropdown align="right" width="48">
                ...
                <x-slot name="content">
                    ...
                    {{-- TODO: Ensure you can only edit your own tickets --}}
